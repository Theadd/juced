...
*/
class JUCED_ColourPropertyComponent  : public TextWithButtonPropertyComponent,
...
public:
    ...
    */
	JUCED_ColourPropertyComponent (const Value &ValueToControl, const String &propertyName) : TextWithButtonPropertyComponent(ValueToControl, propertyName)
    {
